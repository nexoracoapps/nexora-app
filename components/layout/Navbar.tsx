...
{ label: t('contact'), href: '#contact' },
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu — CSS max-height transition, more reliable on iOS than framer-motion height:auto */}
      <div
        className="lg:hidden border-t border-white/5 bg-[#0f1120]/95 backdrop-blur-xl overflow-hidden transition-all duration-200 ease-in-out"
